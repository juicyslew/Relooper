...
public class SecondPersonController : MonoBehaviour
{
    ...
    void Fire()
    {
        if (Shots.Count > 0)
        {
            ...
            var randomNumberX = UnityEngine.Random.Range(-Spray, Spray);
            var randomNumberY = UnityEngine.Random.Range(-Spray, Spray);
            var randomNumberZ = UnityEngine.Random.Range(-Spray, Spray);
